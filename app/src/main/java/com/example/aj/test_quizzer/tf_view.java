...
public class tf_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tf_view); // Setting true false view activity (for attempting true false) as the view for this java file
    }

    public void next_ques(View v)
    {
        if(num_ques_rem >0) {
            Intent pass_num_ques = new Intent( tf_view.this, tf_view.class); // Creating an intent to pass number of questions
        ...
        else if (num_ques_rem == 0)
        {
            ...
            startActivity(new Intent(tf_view.this, Quiz_view.class));
            this.finish(); // Finishing the current activity
        }
    }
}
