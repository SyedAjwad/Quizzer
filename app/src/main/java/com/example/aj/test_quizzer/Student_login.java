...
public class Student_login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_login); // Setting Student login activity as the view for this java file
    }
    ...
    public void auth_signin(View v) { // If sign in button is pressed
        ...
        if (!(user_name.isEmpty()) && !(password.isEmpty())) { // Checking if the fields are empty or not
            startActivity(new Intent(Student_login.this, Quiz_view.class)); // Opening Viewing Available Quizzes View for teachers
    ...
    {
        startActivity(new Intent(Student_login.this, Sign_up.class)); // Opening sign up page for them
        this.finish(); // Finishing the current activity
    }
}
